...
public:
	...
	void GLPA_asyn_pointer_qiao_v1(); // modified version by qiao_yuchen with openmp
	...
	int selectMostFrequentLabel_v5(map<int, int>& labelsList, MTRand& mtrand1_s, vector<pair<int, int>>& wordsList, vector<int>& mostLabelsList);
